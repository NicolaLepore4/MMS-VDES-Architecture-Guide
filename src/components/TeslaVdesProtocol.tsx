...
export const TeslaVdesProtocol = ({ lang }: { lang: Language }) => {
  ...
  return (
    ...
    >
      ...
      {/* 13. Integrazione TESLA con MMS (RTCM 13900.0) */}
      <section className="space-y-6">
        <h2 className="text-2xl lg:text-3xl font-black text-slate-900 tracking-tight uppercase border-b border-slate-200 pb-3">
          {t.teslaMMSTitle}
        </h2>
        ...
        <h3 className="text-xl font-black text-slate-800 uppercase tracking-tight mb-4">
          {t.teslaMMSKeyDistTitle}
        </h3>
        <p className="text-sm text-slate-700 leading-relaxed mb-4">
          {t.teslaMMSKeyDist}
        </p>
        <h3 className="text-xl font-black text-slate-800 uppercase tracking-tight mb-4">
          {t.teslaMMSKeyPacketsTitle}
        </h3>
        <p className="text-sm text-slate-700 leading-relaxed mb-4">
          {t.teslaMMSKeyPackets}
        </p>
        <h3 className="text-xl font-black text-slate-800 uppercase tracking-tight mb-4">
          {t.teslaMMSBootstrapTitle}
        </h3>
        <p className="text-sm text-slate-700 leading-relaxed mb-4">
          {t.teslaMMSBootstrap}
        </p>
        ...
        <pre className="bg-slate-900 text-slate-100 rounded-xl p-4 overflow-x-auto text-sm my-4">
          <code>{t.teslaUMLDiagram}</code>
        </pre>
      </section>

      {/* 14. Ridefinizione del middleware: MMS Edge Router VDES-enabled */}
      <section className="space-y-6">
        <h2 className="text-2xl lg:text-3xl font-black text-slate-900 tracking-tight uppercase border-b border-slate-200 pb-3">
          {t.teslaMiddlewareRedefTitle}
        </h2>
        <h3 className="text-xl font-black text-slate-800 uppercase tracking-tight mb-4">
          {t.teslaAlignTitle}
        </h3>
      ...
      <footer className="mt-16 pt-6 border-t border-slate-200 text-sm text-slate-500">
        <p>
          📘 <strong>MMS-VDES Architecture Guide</strong> —{' '}
          <a
        ...
        <p className="mt-2 italic">{t.teslaFooterCredit}</p>
      </footer>
    </motion.div>
  );
};
